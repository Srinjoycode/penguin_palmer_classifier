...
This app is used to predict the species of the 'Palmer Penguins' database
...
uploaded_file = st.sidebar.file_uploader('penguins_example.csv')
...
if uploaded_file is not None:
    ...
    st.write('Waiting for a file upload by user')
    st.write(df)
